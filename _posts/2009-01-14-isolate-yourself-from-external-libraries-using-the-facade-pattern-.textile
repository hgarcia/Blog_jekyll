...
summary: &amp;#160;   Besides programming against Interfaces and using <a href="http://en.wikipedia.org/wiki/Dependency_injection" target="_blank">Dependency Injection</a> to reduce coupling, there is another practice that can/should be used when you con...
---
&amp;#160;
