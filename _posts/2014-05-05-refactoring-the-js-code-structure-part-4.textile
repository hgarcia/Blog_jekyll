...
__This is part 4 of a series of articles that document my efforts on building a mobile application for iOS using web technologies.__
...
*	"Part 3- Recording Geo location data with PhoneGap and Angular":http://blog.dynamicprogrammer.com/2014/05/02/recording-geolocation-data-PhoneGap-part-3.html
