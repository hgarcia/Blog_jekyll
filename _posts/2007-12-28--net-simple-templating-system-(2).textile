...
<pre lang="csharp">Hello Hernan our records indicate that you purchased the book: Agile Web Development with Rails.</pre>You can find the new code <a target="_blank" href="images/posts/latrompalibraries.zip">here</a>.
