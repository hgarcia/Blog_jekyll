...
summary: On how using MVC 3, NuGet, MvcScaffold, EF code first, Git and AppHarbor make me have fun again in the Microsoft stack.
...
h4. So you get done really fast, so how about going live?
