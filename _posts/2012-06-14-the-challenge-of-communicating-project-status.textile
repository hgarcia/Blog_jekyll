---
layout: post
title: Managing and communicating project status.
summary: .
categories: [Process]
published: false
---
...
For distibute teams, Skype can be used for standups and there are multiple electronic Kanban boards.

At a macro level, the backlog should be used.
...
An upper manager may be happy with a dashboard where he can sign up and see the current milestone status as long as he understand what that means.

Middle management may need to know with higer details about bugs and features in a current iteration.
