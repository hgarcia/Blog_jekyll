...
{% highlight js %}
	...
	var LaTrompa = {};
	LaTrompa.Templates = {};
	LaTrompa.Templates.movieDisplay = "<div class=\"movieContainer\">\n<h4 class=\"movieTitle\">#{title}</h4>\n";  
	LaTrompa.Templates.movieDisplay += "<img src=\"#{dvdCover}\" class=\"movieCover\" alt=\"#{title}\" />\n";
	LaTrompa.Templates.movieDisplay += "<p>#{description}</p>\n</div>\n";
...
{% highlight aspx-cs %}
<pre lang="csharp"> string txt = "<div class=\"movieContainer\">n<h4 class=\"movieTitle\">#{title}</h4>\n";<br/>  txt += "<img src=\"#{dvdCover}\" class=\"movieCover\" alt=\"#{title}\" />\n";<br/>  txt += "<p>#{description}</p>\n</div>\n";<br/> <br/>  Template t = new Template(txt);<br/>  string processed = t.Process(new { title = "The title", description = "The description", dvdCover="cover.jpg"}, true, true);<br/>  Console.Write(processed);<br/> </pre>
{% endhighlight %}
