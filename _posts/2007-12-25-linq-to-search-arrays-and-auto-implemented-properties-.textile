...
summary: This is a cool example I haven't see before of using LINQ to query and filter an array. I like this use of LINQ, it shows the power of the language and what I think is a much useful "usage"...
