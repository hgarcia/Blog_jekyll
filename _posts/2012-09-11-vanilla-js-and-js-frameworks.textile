...
The secondary reason, but significant less important, is the different verions of JavaScript or ECMAScript. 

__This changed in the last few years with both Firefox and Chrome frecuently releasing new versions.__
...
Even Microsoft tried to get into the js libraries for some time with Atlas, later rebranded as Microsoft Ajax something or the other.

JQuery was a bit like the horse that starts the race in the midle of the pack and starts to pick up ground little by little until sudenly is the leader and everybody is trying to catch up to him.
...
On top of custom builded libraries/frameworks; the community is working in different solutions for packaging and the modularization of code. 
...
Libraries are here to stay and that's a good thing. Good libraries allow you to concentrate in the problem at hand. As with any language, you have to make sure to chose wiselly.
