...
{% highlight xml %}
<xslReportBuildPlugin description="PartCover Details" actionName="PartCoverDetailsBuildReport" xslFileName="xsl\PartCover.class.report.xsl" />
{% endhighlight %}
...
<h3>Running PartCover.Net from Nant</h3>
I decided to Run PartCover from Nant using and exec task. This is an example:

{% highlight xml %}
<property name="partCoverReportPath" value="D:\BuildReports\PartCover\${projectName}\" /> <property name="nunitExePath" value="D:/NUnit-2.4.7/bin/nunit-console.exe" />
...
<h3>Adding the report to the build</h3>
...
<merge>
<files>
<file>D:\BuildReports\PartCover\LaTrompaLibraries\UnitTesting-Results.xml</file> 
{% endhighlight %}
