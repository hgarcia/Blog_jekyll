...
summary:    Lava lamps, Orbs, led displays, they all have been used and are still being used to show the build status of projects under Continuous Integration.    What about using a big flat panel TV? Cruise Control provides information via xml as a servi...
---
  ...
  <a href="images/posts/WindowsLiveWriter/BigVisibleCruiseCruisecontrolprojectstat_14B95/image_2.png"><img title="image" style="border-right: 0px; border-top: 0px; display: inline; border-left: 0px; border-bottom: 0px" height="284" alt="image" src="images/posts/WindowsLiveWriter/BigVisibleCruiseCruisecontrolprojectstat_14B95/image_thumb.png" width="393" border="0" /></a>
