...
<blockquote style="background-color: #FFFFFF; font-style: italic; margin: 1.5em; padding: 1.5em; width: 90% !important;">
...
h4. Anonymous, first class functions and closures.
...
h4. Named and optional parameters.
...
h4. Constructor member variable initialization.
...
h4. Automatic getters and setters.
