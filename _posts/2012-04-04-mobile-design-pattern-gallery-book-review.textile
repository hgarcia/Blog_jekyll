...
The book covers pretty much any common need you will have while creating a mobile application. It covers a large variety of platforms, clearly illustrating the differences of each one and how to implement a given pattern efficiently or properly due to those differences.
