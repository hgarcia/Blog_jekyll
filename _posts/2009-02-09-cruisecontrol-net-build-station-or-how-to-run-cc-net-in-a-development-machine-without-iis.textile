...
I just saw this project in Codeplex; <a href="http://www.codeplex.com/CCNetBuildStation" target="_blank">CruiseControl.Net build station</a> sounds interesting and very useful if you happen to work in a machine without IIS.
...
You can also use Hudson, another one that doesn’t requires IIS, free, open source and very extensible. But sometimes you need to use cc.net and I thought that this was a nice alternative on those situations.