...
The tricky part was to detect anythin less than IE 8. My first attempt was to use <span class="code">!document.querySelector</span> but IE9 was given a false positive.
