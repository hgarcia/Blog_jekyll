---
layout: post
title: Detecting IE less than 8 with JS
...
The tricky was to detect IE 8 and up. My first attempt was to use <span class="code">!document.querySelector</span> but IE9 was given a false positive.
