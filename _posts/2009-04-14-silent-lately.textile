...
layout: post
title: Silent lately
summary: &amp;#160;   I have been silent lately because I have been working on a project based on ASP.NET MVC. The idea is to have the bare minimum to create highly configurable sites.   The main obstacles I saw with the framework “out of the box” i...
---
&amp;#160;
