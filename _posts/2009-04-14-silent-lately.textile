...
layout: post
title: Silent lately
summary:    I have been silent lately because I have been working on a project based on ASP.NET MVC. The idea is to have the bare minimum to create highly configurable sites.   The main obstacles I saw with the framework “out of the box” is how to cre...
---
  ...
  <h3>2. Views should be valid html.</h3>  Ok, I know that this is controversial. I consider myself a pragmatism. I’m a proponent of semantic html and Css based layouts instead of tables.
  ...
  <pre class="geshifilter-xml"><span class="sc3"><span class="re1">&amp;lt;viewdata</span> <span class="re0">products</span>=<span class="st0">&amp;quot;IEnumerable[[Product]]&amp;quot;</span><span class="re2">/&amp;gt;</span></span>
...
ex: <a href="http://www.domain.com/movies/list">www.domain.com/movies/list</a> should use the same code but look different to <a href="http://www.anotherdomain.com/movies/list">www.anotherdomain.com/movies/list</a>


<h3></h3>

<h3>4 and 5. Widgets on pages.</h3>
