...
<a href="http://oreillynet.com/pub/reviewproduct/651" target="_blank"><img class="img-float-right"  src="../../../images/posts/mobile_design_patterns.gif" border="0" alt="Responsive Web Design - book cover"/></a>This book by "Theresa Neil":http://www.theresaneil.com/ covers pretty much any common need you will have while creating a mobile application. It covers a large variety of platforms, clearly illustrating the differences of each one and how to implement a given pattern efficiently and properly due to those differences.
...
__<a href="http://oreilly.com/bloggers/"><img alt="I review for the O'Reilly Blogger Review Program" src="http://cdn.oreilly.com/bloggers/blogger-review-badge-125.png" border="0" width="125" height="125" style="margin-right: 1em;"></a>__
