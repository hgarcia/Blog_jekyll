...
After looking around in the web to some of the usual suspects I decided to try  <span class="code">$script</span> this time but I wanted to internalize it into my own code.
