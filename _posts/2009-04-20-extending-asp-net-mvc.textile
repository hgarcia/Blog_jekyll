...
<h3>How to deal with the composition of the view.</h3>  
...
{% highlight aspx-cs %}
	...
	{
		IProngHornLayout GetLayout(IProngHornControllerContext context);
	}
{% endhighlight %}
...
{% highlight aspx-cs %}
	public class ProngHornLayout : IProngHornLayout
	{
		private IDictionary<string, IProngHornLayoutAreas> _areas = new Dictionary<string, IProngHornLayoutAreas>();
	
		public ProngHornLayout(string layoutPath)
		{
		...
		public IDictionary<string, IProngHornLayoutArea> Areas
		{
			get { return _areas; }
			set { _areas = value; }
		}
...
{% highlight aspx-cs %}
	public interface IProngHornLayoutArea
	{
		IDictionary<string, IWidget> Widgets { get; set; }
	}
{% endhighlight %}
...
{% highlight aspx-cs %}
	...
	{
		IProngHornControllerContext ControllerContext { get; }
		IList<string> Scripts { get; set; }
		IList<string> StyleSheets { get; set; }
...
{% highlight aspx-cs %}
	public class ProngHornViewDataDictionary : ViewDataDictionary, IProngHornViewDataDictionary
	{
		public ProngHornViewDataDictionary()
		{
			Containers = new Dictionary<string, IProngHornLayout>();
		...
		public IDictionary<string, IProngHornLayout> Areas { get; set; }
	}
{% endhighlight %}
