...
As you can see nothing really extraordinary. Latelly the coding part at work occupies only 10 to 20 percent of my time, with the bulk of my time on lots of meetings, emails and writing documents.

h3. The road to productivity.

I first tried to organize myself using just todo lists. I try paper and electronic lists. Seemed to work ok for either the big stuff or the small stuff, once I started to put everything together, priorities started to get blury and I found myself focusing in the stuff I wanted to do instead of what needed to be done.
...
Next was the Pomodoro thing. I think I knew about it, but first came to really internalize it during "David Laribee's":http:thebeelog.com workshop at Codemash last year. Using Pomodoro was somehow unrelated to my other efforts towards organization and the main reason was to be able to code for at least 25 minutes without getting distracted by email or phone calls. 
I use an electronic timer "Pomodario":http://TODO that has a task list integrated, so you can track your pomodoros per task if you want, how many interruptions you suffer and you can even provide estimates for your task (in pomodoros). 

__A big thank should go to @aalear:http://twitter.com/aalear since I found "Pomodario" via one of her tweets.__
...
<em>I usually have no problems concentration wise, specially if I'm coding or doing something that I really enjoy. I'm able to tune out the world completelly. My wife jokes with how allienated I can be when I get into "coding" trance. The concentration problems started at work where a hundred diferent things require my attention.</em>

h3. Email entrophy.

I really hated the amount of junk I started to accumulate in my email Inbox. So I made a real effor to clean it up. I used to get 2 to 3 hundred emails a day and I dealt with them almost instantly. This was a problem, a distraction. On top of that I still had around a 100 emails sitting in the Inbox to deal with later. Some of those emails were 3 years old.
...
__I have been thinking about getting rid of the multiple folders and just get a few clearly labebled ones. Not sure if or when I will do that.__
...
If I found myself copying the same thing from one day to another and is actually something that neeed to get done (something that will get my in trouble if I drop ir) I just move it to the top of the list and handle it that day. If not I just drop it from that list into a project list to do later some time or in some cases I just forget about it all together.

I use the pomodoro technique for anything that will take me more than 5 minutes to finish. I usually transfer the task into "Pomodario" to help me keep track of time.

h3. Project lists.

I also keep a project list. This list keep names of projects that I need to work on. The different task for those projects will find their way into the daily commitments list as I work on them. The project list is kept electronically using "Remember The Milk":http://rememberthemilk.com
