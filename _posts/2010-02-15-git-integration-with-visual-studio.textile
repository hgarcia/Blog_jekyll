...
For example you can commit after doing some work on your project (Note: It looks like you have to be in at the project level and not at the solution level in the solution explorer for the commands to work. Although they work in the whole solution as expected.)
