...
summary:    I got a copy of the MEAP edition for ASP.NET MVC in Action. This is the book on the (new?) ASP.NET MVC framework written by Jeffrey Palermo, Ben Scheirman, and Jimmy Bogard.   I have been looking forward to both the final release of the framew...
...
---
  ...
  I will keep reading and waiting for updates on the book, I’m specially high on my expectations for <em>Chapter 13 - IronRuby, IronPython, and the DLR,</em> that is not available yet.
