...
<em>This post is mostly a set of notes that I took live during the session.</em>

Presenter: "Adam Goucher":http://adam.goucher.ca/ 
"Twitter":http://twitter.com/#!/adamgoucher
...
h4. Make good use of the extension on IDE.
