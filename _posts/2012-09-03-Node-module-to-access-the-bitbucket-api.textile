...
At the moment it covers issues and all related objects (components, milestones, versions and issues comments).
...
Almost complete docs in the "https://bitbucket.org/hgarcia/node-bitbucket-api":README.md
...
I want to add better error messages and provide better error checking when working with some of the more complex objects (Issues).
