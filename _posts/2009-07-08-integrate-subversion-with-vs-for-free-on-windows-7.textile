...
<br>In a <a title="previous" href="2009/02/14/IntegrateVisualStudioWithTortoiseSVNForFree.aspx">previous</a> article I mentioned how to integrate VS 2008 with Subversion for free using a few settings and a script. (go read the previous article to get all the code).
