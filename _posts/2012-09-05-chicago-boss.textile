---
layout: post
title: First web app with Chicago boss,
summary: Chicago Boss is a Rails like web framework on top of Erlang/OTP with really good documentation.
...
I'm not sure if it's me that I'm doing something wrong but this was the only way to get it running.
