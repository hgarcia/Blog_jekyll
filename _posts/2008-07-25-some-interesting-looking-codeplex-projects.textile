...
summary: Here is a list of some projects that look interesting for me.Extension Methods Extravaganza- A collection of some extension methods. You can find extension to the object the ICollection, IEnumerable, IList, String and StringBuilder.
---

Here is a list of some projects that look interesting to me.
...
<li><a href="http://www.codeplex.com/LazyParser" title="LazyParser" target="_blank">LazyParser</a> From the same <a href="http://www.blog.activa.be/" title="Philippe Leybaert" target="_blank">Philippe Leybaertfather</a> of ProMesh and CoolStorage. An expression parser with support for C# syntax, very powerful.</li>
...
<li><a href="http://www.codeplex.com/Json" title="Json.NET" target="_blank">Json.NET</a>Again from <a href="http://james.newtonking.com/" title="James Newton-King" target="_blank">James Newton-King</a> the bare bones for my REST services libraries. More to come in a future post...</li>
</ul>