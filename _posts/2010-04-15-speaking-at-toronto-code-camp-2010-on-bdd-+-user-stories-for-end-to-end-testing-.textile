...
I finally got the courage and sent a proposal for speaking at the Toronto code camp. The good news is that it was accepted and I will be speaking this coming May 1st at this year code camp. 
 ...
 <h5> About my talk.</h5> I will describe what BDD is and give a brief introduction to user stories. I will de demoing how to use them to generate executable code that exercise your system and tells the clients that your program is working as expected.
