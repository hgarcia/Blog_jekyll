...
Now there is another choice and is a set of <a href="http://blog.programmerslog.com/?p=4" target="_blank">configuration options</a> to access TortoiseSVN from inside Visual Studio. The set of configurations provide a tools menus, context menu, and menu bar.
