...
I heared about Github pages some time ago and I first used them 3 months back for one of my project's site. 
It sounded like a good starting point for my new site. 

"Github pages":http://pages.github.com/ are a git based platform to serve just simple static html pages or, if you need more power, a site powered by "Jekyll":http://github.com/mojombo/jekyll/. This sounded like a good point to start. 
...
After a little bit of searching I found "this article":http://gmarik.info/blog/2010/05/10/blogging-with-jekyll-and-heroku-for-free on how to host Jekyll on Heroku and how to create a simple "Rack":http://rack.rubyforge.org/ midleware to add the extension to a URL.
...
I wrote another Ruby script to parse the links and permalinks and generate a bunch of ruby statements that ended up in try_next method of the Rack middleware class.

I will probably refactor this some later on to have some better looking code in here, but does the work.
