...
"Nodester":http://nodester.com/, "Joyent SmartMachine":https://no.de/, "Dotcloud":http://www.dotcloud.com/, "nodejitsu":http://www.nodejitsu.com/#/home and "DuoStack":https://www.duostack.com/ are some of the offerings out there (If I'm missing somebody just ping me).
...
The use of "JSlint":https://github.com/as-jpolo/node-lint can also help you to find common problems in your code before is too late. I recommend running jslint as part of your "build" process. 
...
app.get('/model', function(req,res){
	model.changeStatus(req.body,function(result){
		res.redirect('/ok');
	});
});
</code>
