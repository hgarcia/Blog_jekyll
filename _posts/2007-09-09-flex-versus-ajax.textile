...
<!-- more -->Since version 2.0 (3.0 is coming) Flex is not tied to the server anymore, you still can use the Flex server to use what they call data services but you can use Flex as a front end technology without having to worry about the back-end.
