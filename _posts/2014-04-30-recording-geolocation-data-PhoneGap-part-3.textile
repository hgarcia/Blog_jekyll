...
We will create an angular service that encapsulates PhoneGap's Geo location api and we will save the data to a file.


h3. Our location service.

We want to record the current position of the device and keep recording changes until we tell otherwise.
