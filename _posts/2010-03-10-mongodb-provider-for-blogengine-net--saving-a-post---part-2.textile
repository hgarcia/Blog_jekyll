...
{% highlight aspx-cs %}
	public MongoDb(IMongoMapperFactory mongoMapperFactory, string dbName)
	{
	    _mongoMapperFactory = mongoMapperFactory;
	    _dbName = dbName;
}
{% endhighlight %}
...
{% highlight aspx-cs %}
	private void Db(Action<Database> action)
	{
	   using (var server = getServer())
	   {
	       var db = server.getDB(_dbName);
	       action.Invoke(db);
	   }
	}
	
	private Mongo getServer()
	{
