...
__I haven't tried Bitbucket integration, so not sure how good it is.__
...
__Deploying directly from the IDE may not be a great idea but it's certainly very handy on some cases__
