...
summary: As you may have noted, the blog have changed name, domain and engine. My previous hosting company wasn't able to fix a problem they created with their install of PHP.
categories: [General]
---

As you may have noted, the blog have changed name, domain and engine. My previous hosting company wasn't able to fix a problem they created with their install of PHP. 
...
Another change is on the syndication feed, I decided to start using feedburner, so in case I decide to switch to another platform, subscriber to the feed will not be affected.